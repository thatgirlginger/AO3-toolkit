...
this particular AO3 scraping repository is made customizable to what you want to do with your project. i've included a couple of sample scripts, just to show how i use these, but you could definitely use it as an API
...
that being said, i'd love to hear what you've done with this if you end up using it for a project! i'm on tumblr as secretly-historic and have posted some about fanfic-related topics in the past :-)
